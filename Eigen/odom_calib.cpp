...
int main(int argc, char** argv)
{
    ...
    while (id_s < 5000)
    {
        ...
        else
        {
            ...
            // 填充A, b矩阵
            //TODO: (3~5 lines)
            Eigen::Matrix<double,1,2> A_temp;
            Eigen::Matrix<double,1,1> b_temp;
            A_temp << w_Lt, w_Rt;
            b_temp << s_th;

            A.block<1,2>(id_s,0) = A_temp;
            b.block<1,1>(id_s,0) = b_temp;
            //end of TODO
            w_Lt = 0;
            w_Rt = 0;
            ++id_s;
    ...
    //TODO: (1~2 lines)
    Eigen::MatrixXd result_qr_solve1 = A.colPivHouseholderQr().solve(b);
    J21J22(0) = result_qr_solve1(0);
    J21J22(1) = result_qr_solve1(1);
    //end of TODO
    ...
    double r_R;
    //TODO: (3~5 lines)
    Eigen::MatrixXd result_qr_solve2 = C.colPivHouseholderQr().solve(S);
    b_wheel = result_qr_solve2(0);
    r_L = -J21 * b_wheel;
    r_R = J22 * b_wheel;
    //end of TODO
    cout << "b: " << b_wheel << endl;
